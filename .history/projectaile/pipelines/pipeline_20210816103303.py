...
'''
class PIPELINE:
    def __init__(self, config:dict=None, pipeline_type:str='data_pipeline'):
        if config:
    ...
    def _create_pipeline_from_config(self, config):
        return
    
    def _init_callable_(self, callable_method:function):
    ...
    '''
    def callable(self, callable_method:function)-> function:
